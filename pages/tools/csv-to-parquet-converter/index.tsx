  ...
  return (
    ...
    >
      <Head>
        ...
        <meta
          name="og:description"
          content="Use ChatDB to swiftly convert your CSV files to Parquet format completely in the browser. No sign-ups or data transfer required."
        />
      </Head>
      <div className="mt-10 flex flex-col items-center p-6">
        ...
        <p className="mb-4 text-center text-lg">
          Upload your CSV and get it in Parquet format in a few clicks. No
          server-side processing, everything happens in your browser.
        </p>
        ...
        <div className="my-20 w-full px-6">
          ...
          <p className="mt-6 text-center text-lg">
            ...
            It's highly efficient in both storage and performance while
            supporting all modern data processing tools.
          </p>
        </div>
        <div className="my-20 w-full px-6">
          <h2 className="text-center text-4xl font-bold text-black">
          ...
          <p className="mt-6 text-center text-lg">
            Our tool uses WebAssembly to convert your CSV to Parquet directly in
            the browser. This ensures that your data never leaves your device,
