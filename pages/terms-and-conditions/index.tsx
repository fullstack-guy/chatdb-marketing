        ...
        >
            <div className="px-4 py-8 md:px-8">
                ...
                <section className="my-8">
                    <p className="mt-6 text-md text-left text-gray-700">
                        Please read these Terms carefully before using our services
                    </p>
                </section>

                <section className="mt-4">
                    <h2 className="text-xl font-semibold text-black">1. Usage Restrictions</h2>
                    <p className="mt-6 text-md text-gray-700">
                        You may not misuse our platform. This includes attempting unauthorized access, tampering with data or our platform, or using our services for any illegal activities.
                    </p>
                </section>

                <section className="mt-4">
                    <h2 className="text-xl font-semibold text-black">2. Changes to these Terms</h2>
                    <p className="mt-6 text-md text-gray-700">
                        We may revise these Terms from time to time. Any changes will be posted on this page. Please review the updated terms before continuing to use our platform.
                    </p>
                </section>
                ...
                <section className="mt-4">
                    ...
                    <p className="mt-6 text-md text-gray-700">
                        To the maximum extent permitted by law, we shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, incurred directly or indirectly from your use of our platform.
                    </p>
                </section>

                <section className="mt-4">
                    <h2 className="text-xl font-semibold text-black">4. Communications</h2>
                    <p className="mt-6 text-md text-gray-700">
                        By creating an Account, you may opt to receive newsletters, marketing or promotional materials, and other pertinent communications.
                    </p>
                </section>

                <section className="mt-4">
                    <h2 className="text-xl font-semibold text-black">5. Prohibited Uses</h2>
                    <p className="mt-6 text-md text-gray-700">
                ...
                <section className="mt-4">
                    ...
                    <p className="mt-6 text-md text-gray-700">
                        ...
                        <br></br>
                        <br></br>
                        PostHog is an open-source analytics platform that helps us understand how users interact with our Service and Website.
                        We use the data collected by PostHog to enhance and personalize your experience.
                        Unlike other platforms, PostHog's focus is on privacy, ensuring that user data remains private and is not shared with third parties.
                        For more information on the privacy practices of PostHog, please visit the PostHog <Link href="https://posthog.com/privacy">Privacy Policy</Link>.
                    </p>
                </section>
                ...
                <section className="mt-4">
                    ...
                    <p className="mt-6 text-md text-gray-700">
                        If you have any questions regarding these Terms, you may contact us at caleb@chatdb.ai.
                    </p>
                </section>
