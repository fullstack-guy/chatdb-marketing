...
const Checkout = () => {
  ...
  return (
    ...
    >
      <h1 className="m-4 p-2 text-center text-4xl font-extrabold leading-none tracking-tight text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
        You are subscribing to the{" "}
        <span className="capitalize text-blue-600 dark:text-blue-500">
          {plan}
        </span>{" "}
        Plan.
      </h1>
