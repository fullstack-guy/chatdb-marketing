  ...
  return (
    ...
    >
      <div className="px-4 py-8 md:px-8">
        <h1 className="my-10 text-left text-4xl font-bold text-black md:max-w-4xl md:text-4xl xl:text-6xl">
          Privacy Policy
        </h1>
        ...
        <section className="mt-10">
          ...
          <p className="mt-6 text-lg text-gray-700">
            We are committed to maintaining the privacy and integrity of user
            data. Here are our rigorous measures:
          </p>
          <ul className="mt-4 list-disc pl-8">
            <li className="mt-2 text-lg text-gray-700">
              Our system retains the database table schema to generate the
              database schema flow interface. This schema is encrypted and
              securely stored in a Vault.
            </li>
            <li className="mt-2 text-lg text-gray-700">
              Personal or proprietary data from user databases is never stored
              on our platform.
            </li>
            <li className="mt-2 text-lg text-gray-700">
              We ensure data credentials are encrypted when at rest. When these
              credentials move between secure databases and servers, they are
              tokenized with{" "}
              <Link href="https://basistheory.com/">
                <b>Basis Theory</b>
              </Link>{" "}
              and protected by TLS protocols.
            </li>
          </ul>
        </section>
        ...
        <section className="mt-10">
          ...
          <ul className="mt-2 list-disc pl-8 text-lg text-gray-700">
            <li>
          ...
          <h3 className="my-4 text-xl font-semibold text-black">Use of Data</h3>
          <p className="text-lg text-gray-700">
            ChatDB.ai uses the collected Personal Data for various purposes:
          </p>
          <ol className="mt-2 list-decimal pl-8 text-lg text-gray-700">
            <li>
          ...
          <p className="text-lg font-semibold text-gray-700">
            Once again, we do not store data from your database tables.
          </p>
          <h3 className="my-4 text-xl font-semibold text-black">
            Transfer of Data
          </h3>
