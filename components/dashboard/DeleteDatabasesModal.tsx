...
export default function DeleteDatabasesModal({ open, setOpen }) {
  ...
  } = trpc.databases.getAll.useQuery();
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-md text-gray-500">
                          You have reached the maximum number of databases you
                          can create for your current active plan. Please delete
                          a database to create a new one.
                        </p>
                      </div>
                    </div>
                  </div>
