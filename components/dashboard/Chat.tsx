...
const Chat = () => {
    ...
    const description = "This SQL query selects the Order ID, Customer Name, and Order Date from the Orders and Customers tables.The query joins these tables using an INNER JOIN on the condition that the Customer ID in the Orders table matches the Customer ID in the Customers table."
    ...
    return (
        <>
            ...
            <div className="mockup-code relative rounded-lg bg-[#282a36] p-4">
                <div className="absolute top-5 right-5 text-gray-400 hover:text-gray-200 cursor-pointer">
            ...
            <div className="mt-6 overflow-x-auto">
                <table className="table w-full">
                    <thead>
                        <tr>
                            <th className="text-md font-semibold text-black">Tables Queried</th>
                        </tr>
                    </thead>
                    <tbody>
                        {
